    ...
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute bottom-32 left-40 w-40 h-40 bg-green-500/20 rounded-full blur-xl"
        />
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-white/20 bg-black/50 backdrop-blur-sm rounded-xl placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-12 py-3 border border-white/20 bg-black/50 backdrop-blur-sm rounded-xl placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="h-4 w-4 text-blue-500 border-white/20 rounded focus:ring-blue-500 focus:ring-2 bg-black/50"
                />
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              type="button"
              className="w-full inline-flex justify-center py-2 px-4 border border-white/20 rounded-xl shadow-sm text-sm font-medium text-white bg-black/50 hover:bg-white/10 transition-all duration-200"
            >
