        ...
        <div className="p-8">
          ...
          <form onSubmit={onFormSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <Input name="title" placeholder="Title" value={form.title} onChange={onFormChange} required className="rounded-xl shadow-sm focus:ring-2 focus:ring-primary/30" />
              <Input name="author" placeholder="Author" value={form.author} onChange={onFormChange} required className="rounded-xl shadow-sm focus:ring-2 focus:ring-primary/30" />
              <textarea name="description" placeholder="Description" value={form.description} onChange={onFormChange} className="w-full p-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-primary/30 min-h-[80px] resize-none" rows={3} required />
              <textarea name="summary" placeholder="Summary" value={form.summary} onChange={onFormChange} className="w-full p-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-primary/30 min-h-[80px] resize-none" rows={3} required />
              <Input name="metaTitle" placeholder="Meta Title" value={form.metaTitle} onChange={onFormChange} className="rounded-xl shadow-sm focus:ring-2 focus:ring-primary/30" />
