...
interface BookTableProps {
  books: AdminBook[];
  onViewDetails: (book: AdminBook) => void;
}
        ...
        <TableBody>
          {books.map((book, idx) => (
            <TableRow
              ...
              className={
                idx % 2 === 0
                  ? 'bg-gray-50 dark:bg-neutral-800 hover:bg-primary/5 dark:hover:bg-primary/10 hover:scale-[1.02] transition-all duration-200'
                  : 'bg-white dark:bg-neutral-900 hover:bg-primary/5 dark:hover:bg-primary/10 hover:scale-[1.02] transition-all duration-200'
              }
            >
              ...
              <TableCell className="py-3 px-4">
                <Button
                  variant="outline"
                  className="px-4 py-2 rounded-xl text-white font-semibold shadow hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/50"
