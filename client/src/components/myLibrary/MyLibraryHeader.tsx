const MyLibraryHeader = () => (
  <div className="relative flex flex-col items-center justify-center gap-2 py-8 mb-4 overflow-hidden">
    ...
    <h1 className="text-4xl md:text-5xl font-extrabold text-center bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent animate-gradient-x drop-shadow-lg">
      My Library
    </h1>
